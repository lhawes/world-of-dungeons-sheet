...
import { getSelectedCharacterEquipment } from 'src/state/characters/characterSelectors';
...
export const Equipment = ({}: EquipmentProps) => {
  ...
  const equipment = useMemo(() => getSelectedCharacterEquipment(state), [state[CharacterStateKey]]);
